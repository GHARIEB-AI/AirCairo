"""Change default language to English in split mobile route pages."""
...
def fix_route_file(file_path):
    ...
    # Change body tag to have class="en"
    if '<body>' in content and '<body class=' not in content:
        content = content.replace('<body>', '<body class="en">')
        modified = True
